...
<div class="card">
  ...
  <div class="step"><div class="step-num">1</div><div class="step-txt">Asegúrate de tener visible la <strong>barra de marcadores</strong> en Chrome (Ctrl + Shift + B)</div></div>
  <div class="step"><div class="step-num">2</div><div class="step-txt">Arrastra cada bot desde aquí hasta la barra de marcadores</div></div>
  <div class="step"><div class="step-num">3</div><div class="step-txt">¡Listo! Úsalos directamente desde Dinámica</div></div>
</div>
...
<div class="card">
  ...
  <div class="bot-link">
    <div class="bot-info"><span class="bot-emoji">🔬</span>
      <div><div class="bot-nombre"><a id="link-examenes" href="#">Exámenes</a></div><div class="bot-desc">Solicitud de exámenes</div></div>
    </div><span class="drag-hint">← arrastra</span>
  </div>

  <div class="bot-link">
    <div class="bot-info"><span class="bot-emoji">🔪</span>
      <div><div class="bot-nombre"><a id="link-cirugia" href="#">Cirugía</a></div><div class="bot-desc">Prequirúrgicos y consentimiento</div></div>
    </div><span class="drag-hint">← arrastra</span>
  </div>

  <div class="bot-link">
    <div class="bot-info"><span class="bot-emoji">💊</span>
      <div><div class="bot-nombre"><a id="link-formulacion" href="#">Formulación</a></div><div class="bot-desc">Fórmula médica oftalmológica</div></div>
    </div><span class="drag-hint">← arrastra</span>
  </div>

  <div class="bot-link">
    <div class="bot-info"><span class="bot-emoji">📋</span>
      <div><div class="bot-nombre"><a id="link-hsb" href="#">Inicio HSB</a></div><div class="bot-desc">Abre historia clínica en HSB</div></div>
    </div><span class="drag-hint">← arrastra</span>
  </div>

  <div class="bot-link">
    <div class="bot-info"><span class="bot-emoji">📋</span>
      <div><div class="bot-nombre"><a id="link-cami" href="#">Inicio CAMI</a></div><div class="bot-desc">Abre historia clínica en CAMI</div></div>
    </div><span class="drag-hint">← arrastra</span>
  </div>
</div>
