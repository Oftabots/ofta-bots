...
<title>Instalar Oftabots</title>export default function handler(req, res) {
  res.setHeader('Content-Type', 'text/html; charset=utf-8');
...
document.getElementById('link-notas').setAttribute('href', notasHref);
document.getElementById('link-productividad').setAttribute('href', productividadHref);
</script>
</body>
</html>`);
}
...
<div class="card">
  ...
  <div class="bot-link">
    <div class="bot-info"><span class="bot-emoji">📋</span>
      <div><div class="bot-nombre"><a id="link-historia" href="#">Abrir Folio</a></div><div class="bot-desc">Abre historia clinica en cualquier sede</div></div>
    </div><span class="drag-hint">← Arrastra</span>
  </div>

  <div class="bot-link">
    <div class="bot-info"><span class="bot-emoji">📝</span>
      <div><div class="bot-nombre"><a id="link-notas" href="#">Historia Clinica</a></div><div class="bot-desc">Historia Clinica Oftalmologica</div></div>
    </div><span class="drag-hint">← Arrastra</span>
  </div>
